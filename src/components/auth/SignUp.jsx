...
export default function Login() {
    ...
    return (
        <div className='flex md:flex-row md:mx-20 h-full mx-4'>
            ...
            <div className="flex flex-col  text-left  mt-20  gap-2 mx-auto md:px-72 px-4">

                <div className="flex justify-between text-3xl">
                    <Link className=' ' to={'/'}>realtors.</Link>

                    <Link to={'/login'} className='text-xl underline cursor-pointer'>Log In</Link>

                </div>

                <h1 className='text-3xl font-medium'>Create a Free Account </h1>
                ...
                <div className="flex flex-col">
                    ...
                    <input type="email" id='businessName' className='border rounded-lg py-2 focus:border-2 pl-2 invalid:border-red-400' />
                </div>
                ...
                <Link to={'/dashboard'} className='bg-[#F1F252] text-center py-2 rounded-full cursor-pointer'>Proceed to Dashboard</Link>
            </div>
        </div>
    )
}
