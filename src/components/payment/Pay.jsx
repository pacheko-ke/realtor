...
const Pay = () => {
    ...
    return (
        <div className='flex flex-col gap-2 mx-4 mt-10'>
            ...
            <button className='bg-black rounded-md text-white w-full py-1'><img src={Google} alt="" className='mx-auto size-6' /></button>
            <button className='bg-black rounded-md text-white w-full py-1'><img src={Apple} alt="" className='mx-auto size-6 ' /></button>
            <h1 className='my-4'>or pay with other method</h1>
            <div className="flex gap-2 ">
                <div className="flex flex-col py-2 pl-2  pr-16 border rounded-lg border-purple-400 cursor-pointer gap-1">
                ...
                <div className="flex flex-col py-4 px-10 border rounded-lg cursor-pointer" onClick={changePayment}>
                    <h1>Mpesa</h1>
                </div>
            ...
            {/* MPESA PAYMENT */}
            <div className={!payment?'flex flex-col mt-2':'hidden'}>
