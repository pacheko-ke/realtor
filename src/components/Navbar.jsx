...
export default function Navbar() {
  ...
  return (
    ...
    <div className='top-0 fixed w-full shadow-xl z-20'>
      {/* mobile nav */}
      <ul className={navOpen ? 'text-white lg:hidden h-full bg-[#1c1b18] w-3/4 text-5xl gap-2 flex flex-col fixed top-0 pl-2' : 'text-white hidden h-full bg-red-500 w-3/4 text-5xl gap-2  flex-col fixed top-0'}>
      ...
      <div className='bg-[#1c1b18] flex px-4 pt-4 justify-between items-center mx-auto text-white lg:w-3/4'>
        ...
        <ul className='hidden md:flex justify-between gap-6 m'>
          <li>Pricing</li>
          {/* <div className='relative'>
          <h1>To Let</h1>
          <div className='text-sm absolute top-1 right-16 text-black px-1 bg-[#F1F252] rounded-md'>NEW</div>
