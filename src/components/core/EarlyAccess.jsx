...
export default function Newsletter(props) {
  return (
    <motion.div className='flex gap-4 shadow-xl flex-col right-6 left-6 top-[35vh] align-center z-10   md:w-1/4 md:gap-8 align-right bg-gray-800 px-6 py-4 text-white absolute' initial={{ y: 500 }} animate={{ y: 0 }} transition={{ duration: 2, delay: 2 }}>
