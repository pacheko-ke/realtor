...
export default function Newsletter(props) {
  return (
    <motion.div className='flex gap-4 flex-col mx-10 z-20 -mt-24  md:w-1/4 md:gap-8 align-right bg-gray-800 px-6 py-4 text-white' initial={{ y: 500 }} animate={{ y: 0 }} transition={{ duration: 2 }}>
